              ...
              <div>
                ...
                {espVacInfo && espDias > 0 && (
                  <div className="text-xs bg-blue-50/60 rounded-lg px-3 py-2 text-gray-700 mt-1 space-y-0.5">
                    ...
                    <div className="text-gray-400">Base: promedio del imponible (concepto 1) de los últimos 6 meses = {formatPesos(espVacInfo.jornalNominal)}/día; el líquido le descuenta los aportes de seguridad social.</div>
                  </div>
                )}
