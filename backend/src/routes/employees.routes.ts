...
const contratoFields = {
  ...
  cuentaSueldos: z.string().optional(), // cuenta contable / centro de costos
  ...
  // "Aporta Por" del titular/socio sin remuneración: MAXIMO_SUELDO | FICTO | SUELDO
  aportaPor: z.enum(['MAXIMO_SUELDO', 'FICTO', 'SUELDO']).optional().nullable(),
  ...
  try {
    ...
    await prisma.contrato.create({
      data: {
        ...
        aportaPor: c.aportaPor ?? undefined,
  ...
  try {
    ...
    const contrato = await prisma.contrato.create({
      data: {
        ...
        cuentaSueldos: data.cuentaSueldos,
        moneda: data.moneda,
        ...
        aportaPor: data.aportaPor ?? undefined,
