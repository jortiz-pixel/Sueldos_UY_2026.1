...
async function main() {
  ...
  const grupos = [
    ...
    { numero: 4, nombre: 'Industria Textil' },
    { numero: 5, nombre: 'Industrias del Cuero, Vestimenta y Calzado' },
    { numero: 6, nombre: 'Industria de la madera, celulosa y papel' },
    { numero: 7, nombre: 'Industria química, del medicamento, farmacéutica, de combustibles y anexos' },
    { numero: 8, nombre: 'Industria de productos metálicos, maquinarias y equipo' },
    { numero: 9, nombre: 'Industria de la construcción y actividades complementarias' },
    ...
    { numero: 15, nombre: 'Servicios de salud y anexos' },
    { numero: 16, nombre: 'Servicios de enseñanza' },
    { numero: 17, nombre: 'Industria gráfica' },
    { numero: 18, nombre: 'Servicios culturales, de esparcimiento y comunicaciones' },
    { numero: 19, nombre: 'Servicios profesionales, técnicos, especializados y aquellos no incluidos en otros grupos' },
    { numero: 20, nombre: 'Entidades gremiales, sociales y deportivas' },
    { numero: 21, nombre: 'Servicio doméstico' },
    { numero: 22, nombre: 'Ganadería, Agricultura y actividades conexas' },
    { numero: 23, nombre: 'Viñedos, fruticultura, horticultura, floricultura, criaderos de aves, suinos, apicultura y otras actividades no incluidas en el grupo 22' },
    { numero: 24, nombre: 'Forestación (incluido bosques, montes y turberas)' },
  ];
